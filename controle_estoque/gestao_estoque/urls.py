...
from . import views
from .views import buscar_produtos, atualizar_quantidade, diminuir_quantidade, exportar_produtos_xlsx, realizar_devolucao, realizar_emprestimo, verificar_permissao, pagina_inicial, realizar_transacao
...
urlpatterns = [
    ...
    path('realizar-transacao/', views.realizar_transacao, name='realizar_transacao'),
